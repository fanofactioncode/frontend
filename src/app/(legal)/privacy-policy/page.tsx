      ...
      <section className="space-y-14 py-16 text-sm leading-5 text-text-sub sm:text-base">
        <div className="space-y-5 sm:space-y-8">
          ...
          <p>
            ...
            when you use our website and services. By using{" "}
            <Link href="/" className="underline">
              FanOfAction
            </Link>
        ...
        <div className="space-y-3">
          ...
          <ul className="space-y-3">
            ...
            <li className="relative ps-5 before:absolute before:left-0 before:top-[0.5em] before:h-[5px] before:w-[5px] before:rounded-full before:bg-primary">
              ...
              we may collect and display that content along with your username.
            </li>
          </ul>
        </div>
        ...
        <div className="space-y-3">
          ...
          <p>
            ...
            from unauthorized access and use. However, no data transmission over
            the internet or storage system is completely secure, so we cannot
        ...
        <div className="space-y-3">
          ...
          <p>
            ...
            contact us, and we will take appropriate action to delete it.
          </p>
        </div>
